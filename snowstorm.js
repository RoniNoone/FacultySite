...
function SnowStorm() {
  ...
  this.flakeWidth = 75;            // max pixel width for snow element
  this.flakeHeight = 75;           // max pixel height for snow element
  this.vMaxX = 5;                 // Maximum X velocity range for snow  5
  this.vMaxY = 4;                 // Maximum Y velocity range   4
  ...
  this.SnowFlake = function(parent,type,x,y) {
    ...
    this.o = document.createElement('div');
	  this.o.setAttribute('class', 'snow'); //Roni Added
